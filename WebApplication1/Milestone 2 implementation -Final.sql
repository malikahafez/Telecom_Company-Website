...
VALUES 
(1, 'John', 'Doe', 'john.doe@example.com', '123 Elm St', '1990-01-15'),
(2, 'Jane', 'Smith', 'jane.smith@example.com', '456 Oak Ave', '1985-06-25'),
(3, 'Alice', 'Johnson', 'alice.johnson@example.com', '789 Pine St', '1992-03-10');

INSERT INTO Customer_Account (mobileNo, pass, balance, account_type, start_date, status, points, nationalID)
VALUES 
('12345678901', 'password123', 500.0, 'Prepaid', '2023-01-01', 'Active', 150, 1),
('12345678902', 'securepass', 300.0, 'Postpaid', '2022-06-15', 'Onhold', 200, 2),
('12345678903', 'mypassword', 1000.0, 'Prepaid', '2023-05-10', 'Active', 250, 3);

INSERT INTO Service_Plan ( SMS_offered, minutes_offered, data_offered, name, price, description)
VALUES 
( 100, 500, 2000, 'Basic Plan', 10, 'Includes basic SMS, minutes, and data'),
( 200, 1000, 5000, 'Standard Plan', 20, 'Includes more SMS, minutes, and data'),
( 300, 1500, 8000, 'Premium Plan', 30, 'Includes extensive SMS, minutes, and data');
select * from Service_Plan
...
INSERT INTO Payment ( amount, date_of_payment, payment_method, status, mobileNo)
VALUES 
( 10.0, '2023-06-20', 'Credit', 'Successful', '12345678901'),
...
VALUES 
( 100.00, 'USD', '2023-06-20', 1, '12345678901'),
( 50.00, 'USD', '2023-07-15', 2, '12345678902'),
( 200.00, 'USD', '2023-07-10', 3, '12345678903');

INSERT INTO Transfer_money (walletID1, walletID2, amount, transfer_date)
VALUES 
(1 ,2,  50.00, '2023-07-01'),
(2, 3,  30.00, '2023-07-10');

INSERT INTO Benefits (description, validity_date, status, mobileNo)
VALUES 
( 'Extra SMS Offer', '2023-12-31', 'Active', '12345678901'),
( 'Bonus Minutes Offer', '2023-12-31', 'Active', '12345678901'),
( 'Free Data Package', '2023-12-31', 'Active', '12345678902'),
('Cashback Offer', '2023-12-31', 'Active', '12345678903');
...
VALUES 
(1, '123 Main St', '9:00 AM - 5:00 PM'),
(2, '456 Online St', '24/7');


INSERT INTO E_shop (shopID, URL, rating)
VALUES 
(1, 'https://eshop.com', 4),
(2, 'https://eshoponline.com', 5);


INSERT INTO Voucher ( value, expiry_date, points, mobileNo, shopID, redeem_date)
VALUES 
( 10, '2023-12-31', 100, '12345678901', 1, '2023-07-20'),
( 15, '2023-12-31', 150, '12345678902', 2, '2023-07-25'),
( 20, '2023-12-31', 200, '12345678903', 1, '2023-07-30');


INSERT INTO Technical_Support_Ticket ( mobileNo, Issue_description, priority_level, status)
VALUES 
( '12345678901', 'Internet not working', 1, 'Open'),
( '12345678902', 'Phone reception issue', 2, 'Open'),
( '12345678903', 'Unable to make calls', 3, 'In progress');
